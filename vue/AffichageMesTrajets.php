        ...
        <section class="bg-light py-5 border-bottom">
            <div class="container px-1 my-5">
                <div class="text-center mb-5" >
                    <h2 class="display-5 fw-bolder" >Mes trajets</h2>
                </div>
            </div>
        </section><br>
        <div class="row">
                ...
                ?>  
                            ...
                            <div class="card-body p-5" >
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="mb-2">
                                        ...
                                        Conducteur : <?php echo $_SESSION['Prenom']." ".$_SESSION['Nom']  ?>                                        
                                    </li>
                                    <li class="mb-2">
                    ...
                    <a class="btn btn-primary" href="index.php?ctl=Trajet&action=InfoTrajet&id=<?php echo $UnTrajet['ID_Trajet']; ?>">Details</a>
