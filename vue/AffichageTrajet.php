...
#meeting-time{
    ...
    margin-top:0.3%;
        ...
        <section class="bg-light py-5 border-bottom">
            <div class="container px-1 my-5">
                <div class="text-center mb-5">
                        <h2 class="fw-bolder">Trajets disponibles</h2>
                ...
                ?>                    
                    ...
                    <div class="col-lg-4 col-xl-6">
                        ...
                        <div class="d-grid"><a class="btn btn-outline-primary" onclick="return confirm('Êtes-vous sûr de vouloir réserver ce trajet ?');" href="index.php?ctl=Trajet&action=ReserverTrajet&id=<?php echo $UnTrajet['ID_Trajet']; ?>">Réserver</a></div>
                        </div>
                </div>
            </div><?php }} ?>
        </div>
        ...
        <center><h3>Aucun trajet disponible</h3></center><br><br><br>
        <center><i class="fas fa-user-alt-slash fa-3x"></i></center>-->
</section>
