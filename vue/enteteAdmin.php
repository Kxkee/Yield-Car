...
<body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
            <div class="container px-5">
                ...
                <img src="images/logo.png" style="width: 11%; height: 11%; "> <a class="navbar-brand" href="index.php?ctl=connect&action=RetourAccueil">COVOITURAGE</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="index.php?ctl=Trajet&action=Trajets">Offres</a></li>
                         <li class="nav-item"><a class="nav-link" href="index.php?ctl=Utilisateur&action=LesUtilisateurs">Utilisateurs</a></li>
                        <?php }else { ?>
                            <li class="nav-item"><a class="nav-link" href="index.php?ctl=connect&action=connecter">Offres</a></li>
                        <?php }  ?>
                        <?php if (isset($_SESSION['connect'])) {?>
